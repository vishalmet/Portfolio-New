  ...
  return (
    <div id='about-section' className=" bg-gradient-to-b from-gray-800 via-slate-500 to-gray-800 bg-cover bg-center" > 
        ...
        <div className=" pt-12 pb-12 flex-shrink-0" >
          ...
          <div className=" justify-center items-center p-3 mx-6 md:mx-10 md:p-16 lg:mx-20  md:mt-12 rounded-lg flex-shrink-0 border-2 border-white border-glow" data-aos = "flip-right" style={textBG}>
