    ...
    <div id='about-section' className=" bg-gradient-to-b from-gray-800 via-slate-500 to-gray-800 bg-cover bg-center" > 
        ...
        <div className=" pt-12 pb-12 flex-shrink-0" >
          ...
          <div className=" justify-center items-center p-3 mx-6 md:mx-10 md:p-16 lg:mx-20  md:mt-12 rounded-lg flex-shrink-0  hover:scale-105 hover:border-2 hover:border-cyan-300 " data-aos = "flip-right" style={textBG}>
            <div className="flex justify-center">
              <img className=' h-auto rounded-lg  pt-2 border-4 border-white md:pt-0 lg:h-96 ' onContextMenu={(e) => e.preventDefault()} data-aos = "fade-up" src={Me} alt="Vishal" />
            </div>
        ...
        <div className=" flex-row justify-center mt-32 poppins-font">
          ...
          <div className=" text-white flex justify-center space-x-10  mt-6">
            <div className=" p-3 rounded-md w-44 flex justify-center border border-white hover:border-cyan-400" style={textBG} >
            ...
            <div className=" p-3 rounded-md w-44 border border-white hover:border-cyan-400" style={textBG} >
          ...
          <div className=" text-white flex justify-center space-x-10  mt-6">
            ...
            <div className=" p-3 rounded-md w-44 border border-white hover:border-cyan-400 hover:shadow-glow" style={textBG} >
