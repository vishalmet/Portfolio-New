...
export default function Fetch() {
  ...
  return (
    <div className=" h-full  bg-gradient-to-b from-gray-800 via-slate-500 to-gray-800 bg-cover bg-center">
      ...
      <p className=" flex justify-center text-2xl md:text-4xl font-semibold text-white pt-24 md:pt-24 poppins-font text-with-glow">
        CONTACT ME
      </p>
        ...
        <form onSubmit={submit}>
          <div className=" md:flex gap-10 ">
            <div className=" flex-col justify-center items-center">
              <label className=" text-lg md:text-2xl " htmlFor="name">
                Name
              </label>
              <div className="">
                <input
                  className=" border-2 border-cyan-300 rounded-md text-white bg-black"
                  id="name"
                  type="text"
          ...
          <div className=" flex-col justify-center items-center mt-6">
            <label className=" text-lg md:text-2xl " htmlFor="message">
              Message
            </label>
            <div className="  items-center flex justify-center">
              <textarea
                className=" border-2 w-full h-32 border-cyan-300 p-2 rounded-md text-white bg-black"
                id="message"
          ...
          <div className=" mt-2 flex justify-end">
            <button
              className="py-3 px-3 bg-gradient-to-t from-pink-500 via-red-500 to-yellow-500 rounded-lg cursor-pointer font-semibold text-white hover:from-sky-400 hover:to-sky-200 hover:text-black"
              type="submit"
            >
              Send
            </button>
