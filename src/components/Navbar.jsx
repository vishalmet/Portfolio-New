...
const Navbar = () => {
    ...
    return (
        ...
        <div className="bg-cyan-300 pb-3 pt-2 flex justify-between items-center " style={{ boxShadow: '0px 2px 5px rgba(0, 0, 0, 0.1)' }}>
            ...
            <div className={`lg:hidden absolute inset-y-0 z-50 left-0 transform transition duration-300 ease-in-out bg-white w-64 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
