        ...
        <div className="mx-3">
            <div className=" p-10 rounded-3xl md:m-10"style={textBG}>
                    <div className=" pl-1 space-y-1 md:pl-6 lg:pl-10" >
                        <p className='  text-xl pr-3 pb-3 poppins-font font-bold tracking-wide md:text-3xl' style={blueColor}>Intern at SecureDApp</p>
                        <p className=' text-base  poppins-font md:text-2xl text-white'>Frontend Developer & Growth Hacks </p>
                        <p className=' text-base  poppins-font md:text-2xl text-white '><span className=' font-semibold' style={blueColor}>Duration:</span> July 10, 2023 - September 24, 2023</p>
                    </div>
